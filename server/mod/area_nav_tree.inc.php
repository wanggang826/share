<?php
## 大部分数据来源于 http://www.stats.gov.cn/tjsj/tjbz/xzqhdm/201703/t20170310_1471429.html ##
$area_nav_tree = [
    // 4个直辖市
    [
        'province' => '北京市',
    ...
    [
        ...
        'city' => [
            [
                'name' => '天津市',
                'area' => [
                    '滨海新区','和平区','河北区','河东区','河西区','南开区','红桥区','东丽区','西青区','津南区','北辰区','武清区','宝坻区','静海区','宁河区','蓟县'
                ],
            ]
        ]
    ],
        ...
        'city' => [
            [
                ...
                'area' =>  [
                    ...
                    '大足区','渝北区','巴南区','黔江区','长寿区','江津区','合川区','永川区','南川区','璧山区','铜梁区','潼南区','荣昌区','开州区',
                    '梁平县','城口县','丰都县','垫江县','武隆县','忠县','云阳县','奉节县','巫山县','巫溪县','石柱土家族自治县','秀山土家族苗族自治县','酉阳土家族苗族自治县','彭水苗族土家族自治县'
                ],
            ]
        ]
    ],
    ...
    [
      ...
      [
        'name' => '石家庄市',
        'area' => ['长安区','桥西区','新华区','井陉矿区','裕华区','藁城区','鹿泉区','栾城区','井陉县','正定县','行唐县','灵寿县','高邑县','深泽县','赞皇县','无极县','平山县','元氏县','赵县','晋州市','新乐市','辛集市']
      ],
      [
        'name' => '唐山市',
      ...
      [
        'name' => '保定市',
        'area' => ['竞秀区','莲池区','满城区','清苑区','徐水区','涞水县','阜平县','定兴县','唐县','高阳县','容城县','涞源县','望都县','安新县','易县','曲阳县','蠡县','顺平县','博野县','雄县','涿州市','安国市','高碑店市','定州市']
      ],
      [
        'name' => '张家口市',
    ...
    [
      ...
      [
        'name' => '济源市',
        'area' => ['五龙口镇', '下冶镇', '轵城镇', '王屋镇', '思礼镇', '邵原镇', '坡头镇', '梨林镇', '克井镇', '大峪镇', '承留镇', '城区']
      ],
    ]
    ],
    [
      ...
      [
        'name' => '仙桃市',
        'area' => ['郑场镇', '毛嘴镇', '豆河镇', '三伏潭镇', '胡场镇', '长埫口镇', '西流河镇', '沙湖镇',
            '杨林尾镇', '彭场镇', '张沟镇', '郭河镇', '沔城镇', '通海口镇', '陈场镇', '工业园区', '九合垸原种场',
            '沙湖原种场', '排湖渔场', '五湖渔场', '赵西垸林场', '刘家垸林场', '畜禽良种场', '城区']
      ],
      [
        'name' => '潜江市',
        'area' => ['园林', '杨市', '周矶', '广华', '泰丰', '竹根滩镇', '高石碑镇',
            '积玉口镇', '渔洋镇', '王场镇', '熊口镇', '老新镇', '浩口镇', '张金镇', '龙湾镇',
            '江汉石油管理局', '潜江经济开发区', '西大垸管理区', '运粮湖管理区', '周矶管理区',
            '后湖管理区', '熊口管理区', '总口管理区', '高场原种场', '浩口原种场']
      ],
      [
        'name' => '天门市',
        'area' => ['侨乡街道开发区', '竟陵街道', '杨林街道', '佛子山镇', '多宝镇', '拖市镇', '张港镇', '蒋场镇',
            '汪场镇', '渔薪镇', '黄潭镇', '岳口镇', '横林镇', '彭市镇', '麻洋镇', '多祥镇', '干驿镇', '马湾镇', '卢市镇', '小板镇', '九真镇',
            '皂市镇', '胡市镇', '石河镇', '净潭乡', '蒋湖农场', '白茅湖农场', '沉湖管委会']
      ],
      [
        'name' => '神农架林区',
        'area' => ['松柏镇', '阳日镇', '木鱼镇', '红坪镇', '新华镇', '宋洛乡', '九湖乡', '下谷坪乡']
      ],
    ]
    ],
    [
    ...
    [
      ...
      [
        'name' => '深圳市',
        'area' => ['福田区','罗湖区','南山区','盐田区','宝安区','龙岗区','光明新区','龙华新区','坪山新区','大鹏新区']
      ],
      [
        'name' => '珠海市',
        'area' => ['香洲区','斗门区','金湾区']
      ...
      [
        'name' => '东莞市',
        'area' => ['莞城区','南城区','东城区','万江区','石龙镇','茶山镇','石排镇','企石镇','横沥镇',
            '桥头镇','谢岗镇','东坑镇','常平镇','寮步镇','大朗镇','黄江镇','清溪镇','塘厦镇','凤岗镇',
            '长安镇',' 虎门镇','厚街镇','沙田镇','道滘镇','洪梅镇','麻涌镇','中堂镇','高埗镇','樟木头镇',
            '大岭山镇','望牛墩镇']
      ],
      [
        'name' => '中山市',
        'area' => ['石岐街道','东区街道','西区街道','南区街道','五桂山街道','中山火炬高技术产业开发区','黄圃镇','南头镇','东凤镇','阜沙镇','小榄镇','东升镇','古镇镇','横栏镇','三角镇','民众镇','南朗镇','港口镇','大涌镇','沙溪镇','三乡镇','板芙镇','神湾镇','坦洲镇']
      ],
      [
        'name' => '潮州市',
        'area' => ['湘桥区','潮安区','饶平县']
